  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/75db4d02-df74-431f-b04c-db8279a26c7c/id-preview-e2329df3--4e0c83d2-ce68-404c-8971-e4fe2d968f17.lovable.app-1785275529928.png",
      },
      {
        name: "twitter:image",
        content:
