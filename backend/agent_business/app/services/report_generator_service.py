...
Formate la sortie de l'API /business/climate-risk en un document HTML5/CSS3 autonome
...
def _generate_svg_indicator_chart(spi: float, spei: float, ndvi_decay: float) -> str:
    ...
    # Normalisation visuelle des indices [-3.0, +3.0] sur une jauge 0-200px
    ...
    spi_x = _to_x(spi)
    spei_x = _to_x(spei)
    decay_x = round(150 - ndvi_decay * 120, 1)  # Décrément = vers le bas
    ...
    <div class="container">
        ...
        <div class="header">
            <div style="display:flex; justify-content:space-between; align-items:center;">
                <h1>🌿 AgriGuide — Decision Support Report</h1>
