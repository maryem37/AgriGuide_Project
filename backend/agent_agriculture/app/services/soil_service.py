"""
Soil data. SoilGrids is the always-free default (global 250m grid, no
key). Point APIs are queried at the polygon centroid; for larger
parcels, callers should grid-sample (left as a TODO hook below — not
needed for MVP-sized farm parcels).
...
from app.models.schemas import Coordinate, SoilData
