"""
Section 8 — resolves a rough point to an exact parcel polygon.
...
from schemas import ParcelRequest, ParcelResolution, Coordinate, NeighborParcel, NeighborCropContext
from taxonomy import normalize_crop, get_display_name
